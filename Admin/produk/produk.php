...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-danger shadow">
        <div class="container ">
        ...
        <div class="pt-5 pb-3">
            ...
            <table class="table table-striped responsive mt-4 w-100 text-center">
                ...
                <tr>
                    ...
                    <td><?= $row["deskripsi"]  ?></td>
                    <td>
                        <a href="edit.php?id=<?php echo $row['id_produk'] ?>" class="btn btn-outline-success"><i
                                class="bi bi-pencil-square me-3"></i>Edit</a>
                        <a href="delete.php?id=<?php echo $row['id_produk'] ?>" onclick="
