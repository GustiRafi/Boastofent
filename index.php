...
$menu = query("SELECT * FROM produk ORDER BY id_produk DESC");
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-danger fixed-top shadow">
        <div class="container ">
    ...
    <div class="container mt-5">
        <div class="pt-5 pb-3 justify-content-center">
            <div class=" d-flex flex-wrap justify-content-center ">
                ...
                <div class=" box flex-row bg-highlight mb-3 px-4 justify-content-center">
                    <div class="item pb-4 my-5" style="height: 450px;">
                        <div class="text-center pt-0 mt-0 pb-4 mb-3" style="border-radius: 15px;">
                            <div class="card bg-danger text-white shadow bg-dangerpt-0 mt-0 h-auto mb-3"
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="order.php?id=<?=$row['id_produk'] ?>">
                                        <button type="button" class="btn btn-outline-light w-100">Beli</button>
                                    </a>
                                </div>
                            </div>
                        </div>
