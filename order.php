...
$menu = query("SELECT * FROM produk WHERE id_produk = $id")[0];
    ...
    <div class="container mt-5">
        <div class="pt-5 pb-3 ">
            <form action="" method="post">
                <div class="mb-3">
                    <input type="hidden" name="id_menu" id="id" class="form-control" value="<?= $menu['id_produk'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <button type="submit" name="order" class="btn btn-success">Beli</button>
                </div>
            </form>
        </div>
    </div>
